    ...
    <header className="px-5 pt-5 pb-4 space-y-4">
      ...
      <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
        <div className="min-w-0">
          <div className="text-[10px] uppercase tracking-[0.18em] font-semibold text-cyan-400/80 mb-1.5">O19</div>
      ...
      {isO19Simulation(data) ? (
        <div className="glass-card p-4" role="status">
          ...
          <p className="text-[13px] text-slate-400 mt-1">Demo / simulation records are never labeled LIVE. This page does not write HVAC setpoints.</p>
        </div>
      ) : null}

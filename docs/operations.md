...
O16 water-cooled head pressure: `docs/O16-WATER-COOLED-HEAD-PRESSURE.md`. Canonical UI `/agents/variable-speed/variable-head-pressure-water-cooled`. API `/api/agents/variable-speed/o16`.
